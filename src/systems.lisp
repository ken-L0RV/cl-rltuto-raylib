...
(define-system update-entity-visibility ((entity visible location))
...
(define-system draw-visible-items ((entity visible location consumable))
  "draw all visible items with a position"
  (with-slots ((x location/x) (y location/y) (visible visible/visible)) entity
    (when visible
      (unless (or (null x) (null y))
        (draw-creature entity)))))
